...
for f in ['PossessionEngine.cpp','PossessionEngine.h','RitualsEngine.cpp','RitualsEngine.h','Grimoire.cpp','Grimoire.h','FactoryPresetManifest.cpp','FactoryPresetManifest.h','GraveChamber.cpp','LivingCastleEditor.h','SynthesisFamilyContract.h','PerformanceCreatureRoster.h']:require((root/'Source/HorrorCastle'/f).exists(),f'missing {f}')
...
require('CreaturePedestalComponent' in pedestal and 'SUMMON CREATURE' in pedestal and 'TRANSFORM' in pedestal and 'DORMANT' in pedestal,'creature pedestal contract missing')
require('PerformanceCreatureRoster.h' in pedestal and 'drawManifestation' in pedestal and 'MORPH TRAJECTORY' in pedestal,'curated large manifestation UI missing')
require('OSCILLATOR A  •  CRYPT' in pedestal and 'MORPH TRAJECTORY' in pedestal and 'MANIFESTING  //  ' in pedestal,'cinematic oscillator chamber hierarchy missing')
...
require('std::array<std::unique_ptr<CreaturePedestalComponent>,2>' in editor,'two-oscillator performance surface missing')
require('OSCILLATOR A  •  CRYPT' in pedestal and 'OSCILLATOR B  •  TOWER' in pedestal and 'ButtonAttachment' in pedestal,'independent oscillator power UI missing')
require('defaultEnabled = sceneIsCrypt ? (g == 0) : false' in params,'INIT must power only CRYPT oscillator A')
...
require('LIVE BODY  •  SPECTRAL AURA  •  APPARITION WIDTH' in visuals and 'CURRENT MANIFESTATION' in visuals,'visual hierarchy refinement missing')
...
require('nearest generator fingerprint distance' in signature and 'low/mid/high stages' in signature,'all-generator fingerprint regression missing')
...
require('CRYPT SANCTUM // OSCILLATOR A' in chrome and 'TOWER SANCTUM // OSCILLATOR B' in chrome and 'WITNESS CHAMBER' in chrome,'two-sanctum performance chrome missing')
require('drawSanctum' in chrome and 'drawTorch' in chrome and 'life(' in chrome,'reactive two-sanctum chrome missing')
...
print('PASS  performance surface exposes exactly two independent creature oscillators')
print('PASS  public creature menus are curated to distinct synthesis regions')
print('PASS  large audio-reactive manifestations replace tiny generator cards')
print('PASS  cinematic two-sanctum chrome + witness chamber visual hierarchy is present')
print('PASS  shared CRYPT/TOWER coloration injects no fixed pitched bell/drone')
print('PASS  oscillator A/B power is explicit and INIT powers only CRYPT A')
print('PASS  pedestal manifestation/behavior uses actual per-creature audio + physical telemetry')
...
print('PASS  creature selection never overrides explicit oscillator power')
