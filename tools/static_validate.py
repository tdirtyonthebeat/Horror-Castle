...
require('PerformanceCreatureRoster.h' in pedestal and 'drawManifestation' in pedestal and 'TRANSFORMATION //' in pedestal,'curated large manifestation UI missing')
