...
void HexMatrixComponent::setupWidgets(){
    for(int i=0;i<8;++i){
        ...
        const StringArray sources{"Off","Blood","Wraith","Velocity","Key","Random","Pulse"};
...
String HexMatrixComponent::sourceName(ModSource s)const{switch(s){case ModSource::Blood:return"BLOOD";case ModSource::Wraith:return"WRAITH";case ModSource::Velocity:return"VELOCITY";case ModSource::Key:return"KEY";case ModSource::Random:return"RANDOM";case ModSource::Pulse:return"PULSE";default:return"—";}}
