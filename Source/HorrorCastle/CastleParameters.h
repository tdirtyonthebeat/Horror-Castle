...
inline juce::AudioProcessorValueTreeState::ParameterLayout createLayout()
{
    ...
    addFloat("grave.reverb", "Grave Reverb", 0.f, 1.f, .32f); addFloat("grave.delay", "Grave Delay", 0.f, 1.f, .18f); addFloat("grave.feedback", "Grave Feedback", 0.f, .95f, .28f); addFloat("grave.cutoff", "Grave Tone", .02f, .48f, .32f); addFloat("grave.output", "Grave Output", 0.f, 1.f, .78f);
